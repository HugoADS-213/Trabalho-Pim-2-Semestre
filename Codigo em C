...
int main() {
    ...
    do {
        ...
        switch(opcao) {
            case 1: gerarRelatorio("D:\\Python Projetos\\Algoritmos_e_Estrutura_de_Dados_em_Python.csv");
                break;
            case 2: gerarRelatorio("D:\\Python Projetos\\Programacao_estruturada_em_C.csv");
                break;
            case 3:
                gerarRelatorio("D:\\Python Projetos\\Analise_e_Projeto_de_Sistemas.csv");
                break;
            case 4:
                gerarRelatorio("D:\\Python Projetos\\Engenharia_de_Software_Agil.csv");
                break;
            case 0:
